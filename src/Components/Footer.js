    ...
    <>
      <footer className="bg-slate-900 py-10 lg:py-20">
        <div className="max-width grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-5">
          <article>
            <img src={logo} alt=" flogo " height={40} width={200} />
          </article>

          <article>
            <h3 className="text-gray-200 text-lg font-bold tracking-wide">
              Features
            </h3>
            <ul>
              <li>
          ...
          <article>
            <h3 className="text-gray-100 text-lg font-bold tracking-wide">
              Company
            </h3>
            <ul>
              <li>
